...
| 9 — Ampliaciones | `fase9/` (7) | 🔜 **la siguiente** — la 9.4 ya cubre importar/exportar equipos en formato Showdown; la 9.6 (combates dobles en el comparador) y la 9.7 (formas regionales) se añadieron después de cerrar la Fase 8 |
